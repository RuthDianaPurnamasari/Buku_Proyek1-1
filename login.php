	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			<div class="text-center m-b-md custom-login">
				<h3>PLEASE LOGIN TO NS CATERING</h3>
				<?php
                	if(isset($_GET['pesan'])){
                		if($_GET['pesan'] == "gagal"){
                			...
                			echo "Anda harus login untuk mengakses halaman admin";
                                        			...
                                        			echo "Akun anda berhasil di daftarkan, silahkan login menggunakan akun yang baru saja di buat!";
                                        		}
                	}
                	?>
				...
				<div class="hpanel">
                    <div class="panel-body">
                        <form method="post" action="proses_login.php" id="loginForm">
                            ...
                            <a class="btn btn-block" href="register.php">Belum Punya Akun? Daftar</a>
                        </form>
                    </div>
                </div>
			</div>
